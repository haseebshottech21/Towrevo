...
import com.Towrevo.labels.PRIVACY_POLICY
...
//        hashMap[PARAM_USER_TYPE] = PreferenceHelper.getUserType()
    ...
    private fun setTitleBar() {
        /* title bar*/
        titleBarTV.text= LabelUtils.getLabel(this, PRIVACY_POLICY, R.string.privacy_policy)
