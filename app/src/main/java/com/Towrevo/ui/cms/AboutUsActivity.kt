...
import com.Towrevo.labels.ABOUT_US
...
import kotlinx.android.synthetic.main.activity_privacy_policy.privacypolicyWV
...
//        hashMap[PARAM_USER_TYPE] = PreferenceHelper.getUserType()
    ...
    private fun loadWebView(content: String) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            aboutUsWV.loadDataWithBaseURL(null, content, "text/html", "utf-8", null)
        } else {
    ...
    private fun setTitleBar() {
        /* title bar*/
        titleBarTV.text= LabelUtils.getLabel(this, ABOUT_US, R.string.about_us)
