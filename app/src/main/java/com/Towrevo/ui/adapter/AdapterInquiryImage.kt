...
class AdapterInquiryImage(
        val context: Context,
        private val images: MutableList<CustomerDetailsModel.Data.Image>,
        var itemClickedCallback: (Int) -> Unit = {}


) : RecyclerView.Adapter<AdapterInquiryImage.ViewHolder>() {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        init {
            view.addPhotosFL.setOnClickListener {
                itemClickedCallback(adapterPosition)
            }
