    ...
    public static Country getCountryFromSIM(Context context) {
        ...
        if (telephonyManager.getSimState() != TelephonyManager.SIM_STATE_ABSENT) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                if (context.getResources().getConfiguration().getLocales().get(0).getCountry() != null) {
                    return Country.getCountryByISO(context.getResources().getConfiguration().getLocales().get(0).getCountry());
                }
            } else {
                if (context.getResources().getConfiguration().locale.getCountry() != null) {
                    return Country.getCountryByISO(context.getResources().getConfiguration().locale.getCountry());
                }
            }
        }
        return null;
